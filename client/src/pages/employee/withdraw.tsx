...
import { withdrawMoney } from "@/api/accounts";
...
export function Withdraw() {
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    setIsLoading(true);
    try {
      const message = await withdrawMoney(parseInt(data.acc_id), data.amount);
  ...
  return (
    <>
      <div className="space-y-0.5">
        ...
        <p className="text-muted-foreground">Withdraw money from a customer</p>
      </div>
